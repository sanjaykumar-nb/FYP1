...
def build_story2(d):
    ...
    s.append(tbl([
        ["Item", "Value"],
        ["Backend tests", "79 / 79 pass, on SQLite and PostgreSQL 16"],
        ["AI service tests", "75 / 75 pass (pytest -m \"not deferred\")"],
    ...
    s.append(tbl([
        ...
        ["make test", "backend 79, ai-service 75, frontend 53 - also run in CI on every push"],
    ], [0.44, 0.56]))
    s.append(Spacer(1, 8))
