...
| Item | Value |
|---|---|
| Backend tests | 82/82 pass, on both SQLite and PostgreSQL 16 (including a role × endpoint matrix of 170 checks) |
...
| Frontend tests | 58/58 pass (`vitest`), `tsc --noEmit` clean |
...
make test                     # backend 82, ai 85, frontend 58 (also run in CI on every push)
```
